...
/* harmony import */ var src_app_services_data_information_information_repository_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/services/data/information/information-repository.service */ "7IEa");
/* harmony import */ var src_app_services_data_proof_proof_repository_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/services/data/proof/proof-repository.service */ "z1Mc");
/* harmony import */ var src_app_utils_rx_operators__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/utils/rx-operators */ "KJy6");
...
let InformationPage = class InformationPage {
    constructor(route, proofRepository, informationRepository) {
        ...
        this.proof$ = this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(params => params.get('hash')), Object(src_app_utils_rx_operators__WEBPACK_IMPORTED_MODULE_9__["isNonNullable"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(hash => this.proofRepository.getByHash$(hash)), Object(src_app_utils_rx_operators__WEBPACK_IMPORTED_MODULE_9__["isNonNullable"])());
        this.hash$ = this.proof$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["pluck"])('hash'));
        this.locationInformation$ = this.proof$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(proof => this.informationRepository.getByProof$(proof)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(informationList => informationList.filter(information => information.type === "location" /* Location */)));
        this.otherInformation$ = this.proof$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(proof => this.informationRepository.getByProof$(proof)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(informationList => informationList.filter(information => information.type === "other" /* Other */)));
        this.deviceInformation$ = this.proof$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(proof => this.informationRepository.getByProof$(proof)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(informationList => informationList.filter(information => information.type === "device" /* Device */)));
    }
};
...
/* harmony import */ var _information_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./information.page */ "A59R");
...
/* harmony import */ var _information_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./information-routing.module */ "KDNC");
/* harmony import */ var _information_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./information.page */ "A59R");
